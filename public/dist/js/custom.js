...
$(".product-view").on("click", function () {
  ...
  $("#subcategory").text($(this).data("subcategory"));
  $("#child_category").text($(this).data("child_category"));
  $("#product_unit").text($(this).data("unit"));
  $("#product_purchase_price").text($(this).data("price"));
  $("#discount_price").text($(this).data("discount_price"));
  $("#product_stock").text($(this).data("product_stock"));
  $("#product_description").text($(this).data("description"));
  $("#product_return_policy").text($(this).data("return_policy"));
